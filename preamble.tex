...
\renewcommand\subsubsection{
  \@startsection{subsubsection}{3}%
    ...
    {\raggedright\hyphenpenalty=10000\normalfont\normalsize\bfseries}}
\makeatother
\newcommand{\numberedparagraph}{\par\refstepcounter{subsubsection}\textbf{\thesubsubsection}\space}
...
\DeclareCaptionLabelFormat{stblisting}{Рисунок #2}
...
\captionsetup[table]{labelformat=stbtable, justification=raggedright,singlelinecheck=false, font={small}, skip=0pt}
