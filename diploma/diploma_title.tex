\begin{titlepage}
  \begin{center}
    ...
    {на тему:}\\[1em]
    \textbf{\large \MakeUppercase{Персональный ассистент организации времени обучающихся}}\\[1em]


    {БГУИР ДП 1-40 03 01 058 ПЗ}\\[2em]
    % последние 3 цифры номер по приказу
    
    \begin{tabular}{ p{0.65\textwidth}p{0.25\textwidth} }
      Студент & Е.\,В.~Веркович \\
      Руководитель & М.\,Г.~Соколович \\
      Консультанты: &\\
      \hspace*{3ex}\emph{от кафедры ИИТ} & М.\,Г.~Соколович \\
